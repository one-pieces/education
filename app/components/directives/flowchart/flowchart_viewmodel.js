...
(function () {
	...
	// Width of a node.
	//
	flowchart.defaultNodeWidth = 125;
	flowchart.defaultNodeHeight = 86;
	...
	flowchart.ChartViewModel = function (chartDataModel) {
		...
		this.createNewConnection = function (startConnector, endConnector) {
			...
			var tmpConnectionsDataModel = [];
			var tmpConnectionsViewModel = [];
